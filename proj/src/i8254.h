...
#define TIMER_RB_COUNT_  BIT(5) /**< Timer Read Back command count register */
#define TIMER_RB_STATUS_ BIT(4) /**< Timer Read Back command status register */
#define TIMER_RB_SEL(n)  BIT((n) + 1) /**< Timer Read Back command select timer */
